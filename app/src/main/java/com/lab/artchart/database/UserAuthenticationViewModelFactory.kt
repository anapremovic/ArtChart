...
class UserAuthenticationViewModelFactory(private val userViewModel: UserViewModel, private val reviewViewModel: ReviewViewModel) : ViewModelProvider.Factory {
    ...
    override fun<T: ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(UserAuthenticationViewModel::class.java)) {
            return UserAuthenticationViewModel(userViewModel, reviewViewModel) as T
        }
